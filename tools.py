...
def lookup_plant(plant_name: str) -> dict:
    ...
    return {
        ...
        "name": normalized,
        "message": (
            f"No plant named '{normalized}' was found in the database. "
            "The database contains common houseplants like pothos, monstera, snake plant, "
            "fiddle leaf fig, peace lily, and others. If the user described the plant or "
            "used an unusual name, offer general care advice based on their description."
        ),
    }
